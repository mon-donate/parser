...
var charities = [
  {
    ...
    "mondoDescription": "SHORT COURSES          LONDON        GBR".replace(/['"]+/g, ''),
  ...
  {
    "name": "War Child",
    "mondoDescription": "WWW.WARCHILD.ORG.UK    02079169276   GBR".replace(/['"]+/g, ''),
  ...
  },
  {
    ...
    "mondoDescription": "AGAINST MALARIA FO     ST ALBANS     GBR".replace(/['"]+/g, ''),
