...
var charities = [
  {
    ...
    "mondoDescription": "AGAINST MALARIA FO     ST ALBANS     GBR".replace(/['"]+/g, '').toLowerCase(),
  ...
  {
    "name": "War Child",
    "mondoDescription": "WWW.WARCHILD.ORG.UK    02079169276   GBR".replace(/['"]+/g, '').toLowerCase(),
  ...
  },
  {
    ...
    "mondoDescription": "SHORT COURSES          LONDON        GBR".replace(/['"]+/g, '').toLowerCase(),
